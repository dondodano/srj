...
class Organic_Farm_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'organic-farm' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $organic_farm_font_awesome_icon_array = organic_farm_font_awesome_icon_array();
                    foreach ($organic_farm_font_awesome_icon_array as $organic_farm_font_awesome_icon) {
                            $icon_class = $this->value() == $organic_farm_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($organic_farm_font_awesome_icon).'"></i>
                            <span class="organic-farm-social-class">'.esc_attr($organic_farm_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function organic_farm_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'organic-farm-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'organic_farm_customizer_script' );

if(!function_exists('organic_farm_font_awesome_icon_array')){
    function organic_farm_font_awesome_icon_array(){
